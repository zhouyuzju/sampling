...
public class RTEDCommandLine {
	...
	/**
	 * Calculate the tree edit distance between lbltree a and lbltree b
	 * 
	 * @param lbltree a and lbltree b
	 */
	public double calTreeEditDistance(String lbltreeA,String lblTreeB)
	{
		String args[] = {"-t",lbltreeA,lblTreeB,"-v","-o"};
